...
<html>
<head>
    <title><?php echo $cusname."'s " ?> Rents - Car Point</title>
...
$rentedcarsquery1 = "select rentalcarid,name,DATE_FORMAT(rentdate,'%d %M %Y') as rentdate,DATE_FORMAT(startdate,'%d %M %Y') as startdate from rentalcar inner join car inner 
join customer where rentalcarid=car.carid and customer.customerid=rentalcar.customerid and enddate is null and rentalcar.customerid=$cusid order by startdate desc";
...
DATE_FORMAT(enddate,'%d %M %Y') as enddate from rentalcar inner join car inner 
join customer where rentalcarid=car.carid and customer.customerid=rentalcar.customerid and enddate is not null and rentalcar.customerid=$cusid order by startdate desc";
