...
$statusquery2 = "select count(status) as rentedcount from car inner join rentalcar inner join owns where rentalcarid=car.carid and 
...
<html>
<head>
<title><?php echo $dealername."'s " ?> Dashboard - Car Point</title>
...
No cars have been added yet! Add a car by clicking on the <i>Add entry</i> button!
  ...
  LEFT JOIN 
      images 
  ON 
      images.carid = car.carid 
  WHERE 
      car.carid = " . (int)$row["carid"] . " 
  LIMIT 1";
