...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        ...
        <a href="#">
        <img src="assets/img/logo.png" alt="Car Point Dealership Logo" style="width: 100px; height: auto;">
        </a>
        <a class="navbar-brand" href="#" style="color: rgba(114,22,77,0.9)">   CAR POINT <span style="color:black">Dealership</span></a>
                <div class="collapse navbar-collapse" id="navcol-1"><a class="ml-auto" id="loginbut" href="login.php">Login</a></div>
        </div>
    </nav>
    <header class="masthead text-white text-center" style="background: url('assets/img/mainbck.jpg')no-repeat center center;background-size: cover;">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="text-capitalize text-center text-white mb-5">GET! SET! CROOM!</h1>
                </div>
    ...
    <section class="showcase">
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image:url(&quot;assets/img/main1.jpg&quot;);"><span></span></div>
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    <h2 style="color: rgba(114,22,77,0.9);">Latest Deals!</h2>
                    <h2 style="color: rgba(0,0,0,1);">CAR POINT - Your Future Ride!.</h2>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h4 style="color: rgba(0, 0, 0, 0.49);">CAR POINT brings you all range of premium cars at your service.</h4>
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image:url(&quot;assets/img/main3.jpg&quot;);"><span></span></div>
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    <h2 style="color: rgba(114,22,77,0.9);">Best Assured!</h2>
                    <h2 style="color: rgba(0,0,0,1);">We CARE for your CAR!</h2>
                    <h4 style="color: rgba(0, 0, 0, 0.49);">All dealerships care about their customers but CAR POINT takes it to a whole new level.</h4>
                </div>
            </div>
        </div>
    </section>
    <section class="testimonials text-center bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="Images/uzair.jpg">
                        <h5>Muhammad Uzair</h5>
                        <h5>CEO- TESLA, INC.</h5>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"Team CAR POINT has all physics to be the greatest car dealer of all times."</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="Images/haroon.jpg">
                        <h5> Haroon Shangani</h5>
                        <h6>CHAIRMAN- VOLKSWAGEN AG</h6>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"If anyone ask me about the CAR POINT, I'd just say One Word - ELEGANT."</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="Images/aarish.jpg">
                        <h5>Aarish Ayaz</h5>
                        <h5>CEO- LAMBORGHINI</h5>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"Whenever I visit CAR POINT, I feel like Lamborghini is just a portion of it."</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 my-auto h-100 text-center text-lg-left">
                    ...
                    <p class="text-left text-muted small mb-4 mb-lg-0" style="color: rgb(248,249,250);">© CAR POINT. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
