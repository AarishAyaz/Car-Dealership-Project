...
<html>
<head>
    <title><?php echo $dealername."'s " ?> rented cars - Car Point</title>
...
$rentedcarsquery1 = "
select rentalcarid,rentalcar.customerid,customername,name,DATE_FORMAT(rentdate,'%d %M %Y') as rentdate,DATE_FORMAT(startdate,'%d %M %Y') as startdate,startdate as orgstartdate 
from rentalcar inner join owns inner join customer inner join car where rentalcarid=car.carid and rentalcar.customerid=customer.customerid and 
...
from rentalcar inner join owns inner join customer
 inner join car where rentalcarid=car.carid and rentalcar.customerid=customer.customerid and 
