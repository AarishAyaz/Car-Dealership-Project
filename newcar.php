...
// Query to select all car and its dealer details
$query1 = "SELECT 
            car.Name, 
            ...
            newcar.customerid 
        FROM car 
        INNER JOIN newcar ON car.carid = newcar.carid 
        INNER JOIN manufacturer ON car.manufacturerid = manufacturer.manufacturerid 
        INNER JOIN owns ON owns.carid = car.carid 
        INNER JOIN dealer ON owns.dealerid = dealer.dealerid 
...
// Query to get the features of the car
$query2 = "SELECT features FROM features WHERE carid=$carid";

// Execute query
$result2 = mysqli_query($conn, $query2);

// Query to get the images of the car
