...
mysqli_stmt_bind_param($stmt, "sssssss", $name,  $mileage, $color, $fueltype, $m_date,$licenseplateno, $m_id);
    ...
    if(mysqli_stmt_execute($stmt))
    {
        ...
        if(mysqli_query($conn, $ownsquery))
        {
          ...
          $priceinsertquery = "insert into preownedcar(preownedcarid,carid,mileage,resaleprice) values (NULL,$car_id,$mileage,$resaleprice)";
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Add Resale Car - Car Point</title>
    ...
    <div class="testbox">
      ...
      <div class="item">
		...
		<div class="name-item">
          ...
          <input type="number" name="resaleprice" placeholder="Resale Price (in PKR only)" min="0"  required>
        </div>    
