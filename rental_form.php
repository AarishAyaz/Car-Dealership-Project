...
mysqli_stmt_bind_param($stmt, "sssssss", $name,  $mileage, $color, $fueltype, $m_date,$licenseplateno, $m_id);
    ...
    if(mysqli_stmt_execute($stmt))
    {
        ...
        if(mysqli_query($conn, $ownsquery))
        {
          ...
          $priceinsertquery = "insert into rentalcar(rentalcarid,carid,customerid,rentamount) values (NULL,$car_id,$customerid,$rentamt)";
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Add Rental Car - Car Point</title>
  ...
  ?>
    <div class="testbox">
      ...
      <div class="item">
		...
		<div class="item">
          <input type="number" name="rentamt" placeholder="Rent Amount per hour (in PKR only)" min="0"  required>
        </div>    
