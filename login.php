...
if(isset($_POST["submit"]))
{
    ...
    if(mysqli_num_rows($customer_result) == 1)
    {
        ...
        {
            echo "<script> alert(\"Your account has not been verified yet! A verification email has already been sent to $email. Please acknowledge it in order to activate your account! Happy Car Pointing!\")</script>";
        }
    }
    else
    {
...
<div class="main-header"> Login to CAR POINT </div>
...
<div class="main" style="text-align: center;">
    New to CAR POINT? <a href="register.html">Register here</a>
</div>
</div>
</body>
</html>